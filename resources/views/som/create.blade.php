<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Create Sales Organisation Member
        </h2>
    </x-slot>
    ...
    <div>
        <div class="max-w-full mx-auto py-10 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form action="{{ route('som.store') }}" method="post" id="frm">
                    @csrf
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="month" class="block font-medium text-sm text-gray-700">Month</label>
                            <div class="mt-1">
                                <select class="form-input rounded-md shadow-sm mt-1 block w-full" name="month" id="month" value="{{ old('month', '') }}">
